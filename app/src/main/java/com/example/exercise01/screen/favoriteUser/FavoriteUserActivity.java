...
public class FavoriteUserActivity extends BaseActivity implements FavoriteUserContract.view, BaseRecyclerViewAdapter.OnItemClickListener<User> {
    ...
    public static Intent getIntent(Context context) {
        Intent intent = new Intent(context, FavoriteUserActivity.class);
        return intent;
    }
    ...
    public void init() {
        ...
        mAdapter.setIsFavoriteUser(true);
    ...
    @Override
    public void onFavoriteClicked(User item) {
